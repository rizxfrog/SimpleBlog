...
<template>
	<div class="btn-container">
		<div class="btn-drawer transition-top">{{ topText }}</div>
		<div class="btn-drawer transition-bottom">{{ bottomText }}</div>

		<button class="btn" type="button" @click="onClick">
			<span class="btn-text">{{ label }}</span>
		</button>

		<svg class="btn-corner" xmlns="http://www.w3.org/2000/svg" viewBox="-1 1 32 32">
...
const { label, topText, bottomText } = props
</script>
