...
import com.simpleblog.service.BlogSearchService;
...
public class BlogServiceImpl implements BlogService {
    ...
    public BlogPage listBlogs(int page, int size, boolean publishedOnly) {
        ...
        com.baomidou.mybatisplus.extension.plugins.pagination.Page<Blog> request = com.baomidou.mybatisplus.extension.plugins.pagination.Page.of(safePage, safeSize);
        QueryWrapper<Blog> wrapper = new QueryWrapper<>();
        if (publishedOnly) {
            wrapper.eq("is_published", true);
        }
        wrapper.orderByDesc("created_at");
        com.baomidou.mybatisplus.extension.plugins.pagination.Page<Blog> result = blogMapper.selectPage(request, wrapper);
